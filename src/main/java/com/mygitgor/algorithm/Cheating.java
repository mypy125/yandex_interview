...
public class Cheating {
     ...
     * Формат ввода
     * В первой строке находятся два числа N N и M M — количество студентов и количество пар студентов,
     * обменивающихся записками ( 1 ≤ N ≤ 1 0 2 1≤N≤102, 0 ≤ M ≤ N ( N − 1 ) / 2 0≤M≤N(N−1)/2).
     * Далее в M M строках расположены описания пар студентов: два числа, соответствующие номерам студентов,
     * обменивающихся записками (нумерация студентов идёт с 1 1). Каждая пара студентов перечислена не более одного раза.
     * Формат вывода
